...
import { ChevronDown, ChevronUp, MapPin, ExternalLink, Copy, Check, Globe, Layers, Calendar, Hash, User, Award, TreePine, Zap } from 'lucide-react';
import { getCreditAssignmentHistory } from '../utils/blockchain';
...
function CreditHistory() {
  ...
  // Fetch credit assignment history when walletAddress changes
  useEffect(() => {
    async function fetchHistory() {
      if (!walletAddress) {
        setError('Please connect a wallet to view credit history');
        setTransactions([]);
        return;
      }
      ...
      try {
        const result = await getCreditAssignmentHistory(walletAddress);
        if (result.success) {
        ...
        setError(`Error fetching credit history: ${e.message}`);
        setTransactions([]);
      } finally {
        setIsLoading(false);
      }
  ...
  const generateMapUrl = (coordinates) => {
    ...
    // Create Google Maps URL with polygon
  ...
  const getTierColor = (tier) => {
    // Map numeric tiers to strings (in case any numeric tiers slip through)
    const tierMap = {
      '6': 'bronze',
      '7': 'bronze',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 relative z-10">
        ...
        >
          ...
          >
            ...
            <span>Tracking environmental impact for</span>
        ...
        >
          ...
          {isLoading && (
            <div className="p-12 text-center">
              ...
              />
              <p className="text-gray-300 text-lg">Loading carbon credit history...</p>
          ...
          {!isLoading && !error && transactions.length === 0 && (
            ...
            >
              ...
              <p className="text-gray-400 text-xl">No carbon credits found for this wallet</p>
              <p className="text-gray-500 mt-2">Start your environmental journey today!</p>
            </motion.div>
          )}
                            ...
                            <div className="space-y-4">
                              ...
                              <div className="flex items-center gap-3 p-3 bg-gray-800/50 rounded-lg">
                                ...
                                <div>
                                  ...
                                  <p className="text-white font-medium">Afforestation</p>
                                </div>
                              </div>
